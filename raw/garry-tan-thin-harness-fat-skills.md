...
author: Garry Tan
handle: "@garrytan"
platform: x.com (Twitter/X)
fetch_method: user-paste
note: 用户手动粘贴推文全文。原文未经修改，仅 frontmatter 为我方元数据。x.com 反爬机制导致直接抓取不可行。
---
...
The same pattern transfers everywhere: retrieve, read, diarize, count, synthesize. Then: survey, investigate, diarize, rewrite the skill. If you want to know what the most valuable loops are in 2026, it's those. We can apply them to every discipline and walk of life of knowledge work in existence.
