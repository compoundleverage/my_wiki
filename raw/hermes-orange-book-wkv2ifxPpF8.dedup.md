---
derived_from: hermes-orange-book-wkv2ifxPpF8.en.srt
derived_via: srt-dedup-rolling-cue
derived_at: 2026-04-25
source_url: https://www.youtube.com/watch?v=wkv2ifxPpF8
note: 首次真 YouTube auto-caption ingest 派生 dedup sidecar；rolling-cue dedup（取每非短时长 cue 末非空行）
video_title: "How to Make Claude Code Your AI Engineering Team"
uploader: Y Combinator
duration: "00:21:49"
upload_date: 20260423
---

# How to Make Claude Code Your AI Engineering Team —— Auto-caption dedup
...
essentially built all of Posterus, which
took 2 years to build with a co-founder
and a team of 10 engineers. I've
essentially built all of my startup
...
something that you can do when you're at
...
you want to get a beer with and he's got
...
through. So, here's actually a really
...
end we realized, well, we have a browser
...
and then get farther along with it than
...
there's actually a feasibility aspect of
office hours and that's one thing I
...
which does a staff level uh bug catching
...
work tree and each one of these things
