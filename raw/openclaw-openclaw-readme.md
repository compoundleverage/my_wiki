---
source_url: https://github.com/openclaw/openclaw/blob/main/README.md
fetched_at: 2026-04-21
author: Peter Steinberger (steipete) + community
platform: github-repo
fetch_method: curl
note: 原文 verbatim，仅 frontmatter 为元数据；对 /ingest raw/hermes-agent-vs-openclaw.md 做二次校验的官方源
---
